...
public class TestUtils {
    public static final LocalTime TIME830 =  LocalTime.of(8, 30);
    public static final LocalTime TIME1000 = LocalTime.of(10, 00);
    public static final LocalTime TIME1130 = LocalTime.of(11, 30);

    public static final Schedule MTH830to10 = new Schedule(MTH, new Period(TIME830, TIME1000));
    public static final Schedule TF830to10 = new Schedule(TF, new Period(TIME830,TIME1000));
    public static final Schedule TF10to1130 = new Schedule(TF, new Period(TIME1000, TIME1130));
