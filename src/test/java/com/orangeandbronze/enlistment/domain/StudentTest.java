...
class StudentTest {
    ...
    void enlist_within_room_capacity() {
        ...
        Section section = new Section(DEFAULT_SECTION_ID, DEFAULT_SUBJECT, MTH830to10, room, newFaculty(1));
    ...
    void enlist_concurrent_almost_full_section() throws Exception {
        for (int i = 0; i < 20; i++) { // repeat test 20 times
            ...
            Section section = new Section(DEFAULT_SECTION_ID, DEFAULT_SUBJECT, MTH830to10, new Room("Y", 1), newFaculty(1));
    ...
    void enlist_section_prereqs_taken() {
        ...
        Section section = new Section(DEFAULT_SECTION_ID, subject, MTH830to10, new Room("room", 10), newFaculty(1));
